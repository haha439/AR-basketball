...
public class NewBall : prefab_controll
{
    ...
    public override void Start(){
        base.Start();
        GameObject ball = GameObject.Find("instance");
    }
    
}
 
 public class prefab_controll : MonoBehaviour {
 
     // Create AssetBundle variable to store the data of the bundles
     AssetBundle ball_bundle;
     ...
     public void Update () {
         ...
         if (asset_bundles_loaded) {
             ...
             GameObject asset_loaded_prefab = (GameObject) ball_bundle.LoadAsset<GameObject>("ball");
     ...
     IEnumerator load_asset_bundles () {
         ...
         StartCoroutine(load_sub_asset_bundle("ball"));
     ...
     IEnumerator load_sub_asset_bundle (string bundle_name) {
         ...
         switch (bundle_name) {
             case "ball":
                 ...
                 ball_bundle = DownloadHandlerAssetBundle.GetContent(request);
                 break;
             default:
                 break;
         }
